...
QAction *plug::getManagerAction_FromWAPair(QString pluginName, QString waName) {
  return Core::Plugins::instance().plugins().value(pluginName)->getWidgetActionList().value(waName).second;
}
...
QWidget *plug::getManagerWidget_FromWAPair(QString pluginName, QString waName) {
  return Core::Plugins::instance().plugins().value(pluginName)->getWidgetActionList().value(waName).first;
}
...
QAction *plug::getManagerAction_FromActionsList(QString pluginName, QString actionName) {
  return Core::Plugins::instance().plugins().value(pluginName)->getActionList()[actionName];
}
