...
QAction *man::getManagerAction_FromWAPair(QString managerName, QString waName) {
  return CveManager::instance().managers().value(managerName)->getWidgetActionList().value(waName).second;
}
...
QWidget *man::getManagerWidget_FromWAPair(QString managerName, QString waName) {
  return CveManager::instance().managers().value(managerName)->getWidgetActionList().value(waName).first;
}
...
QAction *man::getManagerAction_FromActionsList(QString managerName, QString actionName) {
  return CveManager::instance().managers().value(managerName)->getActionList()[actionName];
}
...
QAction *man::getLoggerAction_FromWAPair(QString waName) {
  return CveManager::instance().logger()->getWidgetActionList().value(waName).second;
}
...
QWidget *man::getLoggerWidget_FromWAPair(QString waName) {
  return CveManager::instance().logger()->getWidgetActionList().value(waName).first;
}
...
QAction *man::getLoggerAction_FromActionsList(QString waName) {
  return CveManager::instance().logger()->getActionList().value(waName);
}
