...
class /*QDESIGNER_WIDGET_EXPORT*/ QLed : public QWidget
{
 Q_OBJECT
  ...
  Q_PROPERTY(bool wink READ wink WRITE setWink)
...
public: 
  ...
  void setOpacity(double value){m_opacity = value; update(); }

  bool wink() const { return m_wink; }
  void setWink(bool value) { m_wink = value; }
